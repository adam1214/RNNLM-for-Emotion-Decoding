...
if __name__ == '__main__':
    ...
    #original_utt_text = joblib.load('../../../../data/original_utt_text.pkl')
    dialog = joblib.load('../../data/IEMOCAP/dialog_rearrange.pkl')
    dialog_edit = joblib.load('../../data/IEMOCAP/dialog_rearrange_4emo_iemocap.pkl')
    emo_dict = joblib.load('../../data/IEMOCAP/emo_all_iemocap.pkl')
    emo_shift_all = joblib.load('../../data/IEMOCAP/4emo_shift_all_rearrange.pkl')
